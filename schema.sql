...
CREATE TABLE IF NOT EXISTS `orderinfo` (
  ...
  KEY `FK9rch7g51op37a8o8uxymlxcd8` (`orderstatus_id`),
  CONSTRAINT `FK8nbthrgma7jd149n5m4xgvep7` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`),
  CONSTRAINT `FK9rch7g51op37a8o8uxymlxcd8` FOREIGN KEY (`orderstatus_id`) REFERENCES `orderstatus` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table op1_backend.orderinfo: ~2 rows (suunnilleen)
/*!40000 ALTER TABLE `orderinfo` DISABLE KEYS */;
INSERT INTO `orderinfo` (`id`, `date`, `customer_id`, `orderstatus_id`) VALUES
	(1, '2023-05-15', 1, 1),
	(2, '2023-05-15', 3, 2);
/*!40000 ALTER TABLE `orderinfo` ENABLE KEYS */;

-- Dumping structure for taulu op1_backend.orderinfo_productorders
DROP TABLE IF EXISTS `orderinfo_productorders`;
CREATE TABLE IF NOT EXISTS `orderinfo_productorders` (
  `orderinfo_id` bigint(20) NOT NULL,
  `productorders_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_i87xe3yfyhb6gx3grjpre3um` (`productorders_id`),
  KEY `FKoa0nlb5vmjh8utjxwwurxapka` (`orderinfo_id`),
  CONSTRAINT `FK11yr6a6et5mpli9wolifirabr` FOREIGN KEY (`productorders_id`) REFERENCES `product_orders` (`id`),
  CONSTRAINT `FKoa0nlb5vmjh8utjxwwurxapka` FOREIGN KEY (`orderinfo_id`) REFERENCES `orderinfo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table op1_backend.orderinfo_productorders: ~0 rows (suunnilleen)
/*!40000 ALTER TABLE `orderinfo_productorders` DISABLE KEYS */;
/*!40000 ALTER TABLE `orderinfo_productorders` ENABLE KEYS */;
...
-- Dumping structure for taulu op1_backend.orderstatus
...
-- Dumping data for table op1_backend.orderstatus: ~2 rows (suunnilleen)
...
-- Dumping structure for taulu op1_backend.orderstatus_seq
DROP TABLE IF EXISTS `orderstatus_seq`;
CREATE TABLE IF NOT EXISTS `orderstatus_seq` (
  `next_not_cached_value` bigint(21) NOT NULL,
  `minimum_value` bigint(21) NOT NULL,
  `maximum_value` bigint(21) NOT NULL,
  `start_value` bigint(21) NOT NULL COMMENT 'start value when sequences is created or value if RESTART is used',
...
-- Dumping data for table op1_backend.orderstatus_seq: ~1 rows (suunnilleen)
/*!40000 ALTER TABLE `orderstatus_seq` DISABLE KEYS */;
INSERT INTO `orderstatus_seq` (`next_not_cached_value`, `minimum_value`, `maximum_value`, `start_value`, `increment`, `cache_size`, `cycle_option`, `cycle_count`) VALUES
	(50001, 1, 9223372036854775806, 1, 50, 1000, 0, 0);
...
-- Dumping structure for taulu op1_backend.product_orders
...
CREATE TABLE IF NOT EXISTS `product_orders` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK3dbb07cs73igb2rf67fog2ty0` (`orderinfo_id`),
  KEY `FK5c959v5pr5pky28q88sbgg8hq` (`product_id`),
  CONSTRAINT `FK3dbb07cs73igb2rf67fog2ty0` FOREIGN KEY (`orderinfo_id`) REFERENCES `orderinfo` (`id`),
  CONSTRAINT `FK5c959v5pr5pky28q88sbgg8hq` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table op1_backend.product_orders: ~2 rows (suunnilleen)
/*!40000 ALTER TABLE `product_orders` DISABLE KEYS */;
INSERT INTO `product_orders` (`id`, `orderinfo_id`, `product_id`) VALUES
	(1, 1, 1),
	(2, 2, 2);
/*!40000 ALTER TABLE `product_orders` ENABLE KEYS */;

-- Dumping structure for taulu op1_backend.product_orders_seq
DROP TABLE IF EXISTS `product_orders_seq`;
CREATE TABLE IF NOT EXISTS `product_orders_seq` (
  `next_not_cached_value` bigint(21) NOT NULL,
  `minimum_value` bigint(21) NOT NULL,
  `maximum_value` bigint(21) NOT NULL,
  `start_value` bigint(21) NOT NULL COMMENT 'start value when sequences is created or value if RESTART is used',
...
-- Dumping data for table op1_backend.product_orders_seq: ~1 rows (suunnilleen)
/*!40000 ALTER TABLE `product_orders_seq` DISABLE KEYS */;
INSERT INTO `product_orders_seq` (`next_not_cached_value`, `minimum_value`, `maximum_value`, `start_value`, `increment`, `cache_size`, `cycle_option`, `cycle_count`) VALUES
	(50001, 1, 9223372036854775806, 1, 50, 1000, 0, 0);
/*!40000 ALTER TABLE `product_orders_seq` ENABLE KEYS */;

-- Dumping structure for taulu op1_backend.product_productorders
DROP TABLE IF EXISTS `product_productorders`;
CREATE TABLE IF NOT EXISTS `product_productorders` (
  `product_id` bigint(20) NOT NULL,
  `productorders_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_5qkk5hnrx2licjhq1iut8ggul` (`productorders_id`),
  KEY `FKpbstv1v93bjstrhylmtkug61g` (`product_id`),
  CONSTRAINT `FKpbstv1v93bjstrhylmtkug61g` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `FKt4ncpohafbtikpnr4de4w18nt` FOREIGN KEY (`productorders_id`) REFERENCES `product_orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table op1_backend.product_productorders: ~0 rows (suunnilleen)
/*!40000 ALTER TABLE `product_productorders` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_productorders` ENABLE KEYS */;
